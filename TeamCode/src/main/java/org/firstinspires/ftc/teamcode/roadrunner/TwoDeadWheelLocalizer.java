...
public final class TwoDeadWheelLocalizer implements Localizer {
    ...
    public static class Params {
        public double parYTicks = -5.883316673618279; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -4.4504565562695975; // x position of the perpendicular encoder (in tick units)
    }
}
